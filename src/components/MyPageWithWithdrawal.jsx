...
const MyPageWithWithdrawal = () => {
  ...
  const texts = {
    ...
    zh: {
      ...
      currentPoints: '目前點數',
      totalEarned: '總獲得點數',
      campaignApplications: '活動申請',
      totalApplications: '總申請數',
      approvedApplications: '已批准申請',
      completedCampaigns: '已完成活動',
      withdrawalHistory: '提款記錄',
      totalWithdrawn: '總提款金額',
      pendingWithdrawals: '待處理提款',
      pointHistory: '點數記錄',
      ...
      bonus: '獎勵',
      withdrawal: '提款',
      withdrawRequest: '申請提款',
      withdrawRequestTitle: '點數提款申請',
      withdrawAmount: '提款金額',
      paypalEmail: 'PayPal 電子郵件',
      paypalName: 'PayPal 帳戶名稱',
      withdrawReason: '提款原因',
      submitWithdrawRequest: '提交提款申請',
      accountDeletion: '刪除帳戶',
      deleteAccount: '刪除帳戶',
      deleteAccountWarning: '刪除帳戶後，所有資料將永久刪除。',
      deleteAccountDescription: '提交刪除帳戶申請後，管理員將進行審核。刪除後所有資料將無法恢復。',
      withdrawalReason: '退出原因',
      withdrawalDetails: '詳細內容',
      confirmDeletion: '確認刪除',
      confirmText: '您確定要刪除帳戶嗎？請輸入「刪除帳戶」以確認。',
      confirmPlaceholder: '刪除帳戶',
      submitWithdrawal: '提交退出申請',
      cancel: '取消',
      processing: '處理中...',
      logout: '登出',
      goHome: '返回首頁',
      ...
      region: '地區',
      bio: '個人簡介',
      instagramFollowers: 'Instagram 粉絲數',
      tiktokFollowers: 'TikTok 粉絲數',
      youtubeSubscribers: 'YouTube 訂閱數',
      roles: {
        user: '一般用戶',
        creator: '創作者',
        vip: 'VIP 用戶',
      ...
      snsUpload: 'SNS 上傳',
      snsUploadUrl: 'SNS 上傳網址',
      pointRequest: '申請點數',
      pointRequestTitle: 'SNS 上傳及點數申請',
      snsUploadDescription: '請輸入您在 SNS 上傳內容的網址並申請點數。',
      additionalNotes: '附加備註',
      submitPointRequest: '提交點數申請',
      pointRequestPending: '點數申請待處理',
      pointRequestApproved: '點數已發放',
      messages: {
        withdrawalSubmitted: '退出申請已提交。管理員將進行審核。',
        error: '發生錯誤，請重試。',
        confirmRequired: '請正確輸入確認文字。',
        reasonRequired: '請選擇退出原因。',
        snsUploadSubmitted: 'SNS 上傳及點數申請已提交。',
        snsUrlRequired: '請輸入 SNS 上傳網址。'
      }
    },
    en: {
      title: 'My Page',
