...
const CampaignApplicationUpdated = () => {
  ...
  const texts = {
    zh: {
      ...
      submit: '提交申請',
      submitting: '提交中...',
      alreadyApplied: '您已申請此活動',
      applicationSuccess: '活動申請已完成！',
      requiredField: '必填項目',
      optionalField: '選填項目',
      reward: '獎勵金',
      participants: '招募人數',
      ...
      brand: '品牌',
      category: '類別',
      profileIncomplete: '請先完成您的個人資料',
      goToProfile: '前往個人資料設定',
      campaignNotFound: '找不到活動',
      loginRequired: '需要登入',
      name: '姓名',
      email: '電子郵件',
      age: '年齡',
      ...
      postalCodeRequired: '郵遞區號為必填',
      addressRequired: '地址為必填',
      phoneRequired: '聯絡電話為必填',
      instagramRequired: 'Instagram 網址為必填',
      targetPlatforms: '目標 SNS 平台',
      ageLabel: '年齡：',
      skinTypeLabel: '膚質類型：',
      offlineVisitCondition: '線下訪問要求',
      offlineVisitNote: '線下訪問備註',
      offlineVisitAvailable: '我可以根據上述條件進行線下訪問',
      people: '人',
      redirectingToHome: '3秒後將返回首頁...'
    },
    ko: {
      title: '캠페인 신청',
