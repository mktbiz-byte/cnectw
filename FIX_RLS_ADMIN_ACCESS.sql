-- =====================================================
-- FIX RLS ADMIN ACCESS - Taiwan Platform
-- =====================================================
...
-- =====================================================
-- STEP 4: Test admin access with direct query
-- =====================================================

-- This should work if RLS is configured correctly
-- Run this after logging in as admin user
-- SET LOCAL ROLE authenticated;
-- SET LOCAL request.jwt.claims TO '{"sub": "USER_ID_HERE", "user_metadata": {"role": "admin"}}';
...
-- =====================================================
-- STEP 6: Create a more permissive admin policy (if needed)
-- =====================================================
...
-- =====================================================
-- 1. Run this SQL in Taiwan Supabase SQL Editor
